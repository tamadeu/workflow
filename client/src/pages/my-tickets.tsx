...
import { Search, Filter, Eye, Edit, User } from "lucide-react";
import { Link } from "wouter";
import { useMyTicketsQuery } from "@/hooks/use-tickets-api";
...
export default function MyTickets() {
  ...
  const { data: tickets = [], isLoading, error } = useMyTicketsQuery();
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <GenericTicketsTable
        ...
        title="Meus Chamados"
        subtitle="chamados criados por você"
        isLoading={isLoading}
        error={error}
        showActions={true}
      />
